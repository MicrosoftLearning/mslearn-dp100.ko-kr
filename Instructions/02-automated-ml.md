...
1. 웹 브라우저에서 https://aka.ms/diabetes-data 에 접속해 쉼표로 구분된 데이터를 확인합니다. 그런 다음 이 데이터를 **diabetes.csv**라는 로컬 파일로 저장합니다. 저장 위치는 상관없습니다.
...
2. 다음 설정을 사용하여 새 자동화된 ML 실행을 만듭니다.
    ...
    - **작업 유형 및 설정**:
        ...
        - **추가 구성 설정 보기**를 선택하여 **추가 구성**을 엽니다.
            ...
            - **차단된 알고리즘**: 기본 설정 *all algorithms can potentially be used when training*을 그대로 유지합니다.
            - **종료 기준**:
...
2. **배포** 옵션에서 **웹 서비스에 배포** 단추를 사용하여 모델을 다음 설정과 함께 배포합니다.
