...
## <a name="work-with-datastores-and-datasets"></a>데이터 저장소 및 데이터 세트 사용

이 연습에서는 데이터 사용을 위한 코드가 Notebook에서 제공됩니다.

1. Jupyter 홈페이지에서 Notebook 리포지토리를 복제한 **/users/*your-user-name*/mslearn-dp100** 폴더로 이동하여 **Work with Data** Notebook을 엽니다.
