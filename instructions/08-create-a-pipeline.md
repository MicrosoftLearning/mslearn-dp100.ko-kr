...
## <a name="create-and-publish-a-pipeline"></a>파이프라인 작성 및 게시

이 연습에서는 파이프라인 작성 및 게시를 위한 코드가 Notebook에서 제공됩니다.

1. Jupyter 홈페이지에서 Notebook 리포지토리를 복제한 **/users/*your-user-name*/mslearn-dp100** 폴더로 이동하여 **Create a Pipeline** Notebook을 엽니다.
