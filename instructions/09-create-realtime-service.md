...
ms.locfileid: "137894485"
---
# <a name="create-a-real-time-inference-service"></a>실시간 유추 서비스 만들기
...
## <a name="create-a-real-time-inferencing-service"></a>실시간 유추 서비스 만들기

이 연습에서는 모델을 실시간 유추 서비스로 배포하기 위한 코드가 Notebook에서 제공됩니다.

1. Jupyter 홈페이지에서 Notebook 리포지토리를 복제한 **/users/*your-user-name*/mslearn-dp100** 폴더로 이동하여 **Create a Real-time Inferencing Service** Notebook을 엽니다.
